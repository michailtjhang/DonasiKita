...
<section class="hero-section2 w-100" style="background-image: url('/images/hero-bg-2.svg');">
    ...
    <div class="hero-content2 text-left px-5 ms-5">
        ...
        <p class="hero-subtitle2-event">Telusuri berbagai acara inspiratif yang mendukung misi kemanusiaan.<br>Setiap partisipasi Anda adalah langkah kecil menuju perubahan besar.</p>
    </div>
</section>
<!-- End Hero Section -->
