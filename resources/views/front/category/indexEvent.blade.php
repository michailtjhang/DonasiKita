                ...
                <a href="{{ route('blogs.category', $category->slug) }}" class="text-decoration-none">
                    <div class="event-card rounded rounded-5">
                        ...
                        <div class="event-details pb-3 px-4">
                            <p class="event-title  mb-3 fw-bold" style="font-size:14px !important">{{ $category->description }}</p>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="pagination-container my-5 pb-5">
            ...
            <div class="pagination-dots" id="pagination-dots">
                @for ($i = 1; $i <= $categories->lastPage(); $i++)
                    <span class="pagination-dot {{ $i == $categories->currentPage() ? 'active' : '' }}" data-page="{{ $i }}"></span>
                    @endfor
            </div>
