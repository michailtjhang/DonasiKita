                ...
                <div class="event-card rounded rounded-5">
                    ...
                    <div class="event-details pb-4 px-4">
                        ...
                        <p class="card-text fw-thin text-extra-small mb-3 opacity-75 p-0 m-0">
                            ...
                            <a href="#" class="text-decoration-none">{{$event->category->name}}</a> | {{$event->organizer}}
                        </p>
                        ...
                        <div class="card-text text-extra-small d-flex justify-content-between">
                            <div class="col-md-6">
                                <i class="fa-solid fa-clock"></i> {{ $event->detailEvent->start->format('H:i') }} - {{ $event->detailEvent->end->format('H:i') }}<br>
                            </div>
                            <div class="col-md-6">
                                <i class="fa-solid fa-location-dot"></i> {{ $event->location->name_location ?? 'Unknown Location' }}
                            </div>
                        </div>
        ...
        <div class="pagination-container my-5 pb-5">
            ...
            <div class="pagination-dots" id="pagination-dots">
                @for ($i = 1; $i <= $events->lastPage(); $i++)
                    <span class="pagination-dot {{ $i == $events->currentPage() ? 'active' : '' }}" data-page="{{ $i }}"></span>
                    @endfor
            </div>
