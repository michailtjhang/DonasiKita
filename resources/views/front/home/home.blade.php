...
@section('meta')
    <meta name="title" content="{{ $config['meta_title'] ?? 'Donasi Kita' }} | {{ config('app.name', 'Donasi Kita') }}">
    <meta name="description" content="{{ $config['meta_description'] ?? 'Donasi Kita' }}" />
    <meta name="keywords" content="{{ $config['meta_keywords'] ?? 'Donasi Kita' }}">
@endsection
@section('content')
    <!-- Hero Section -->
    ...
    <section id="quote-content">
        <div class="container-fluid py-5 justify-content-center text-center bg-skyline">
            ...
            <p class="text-dark text-large">"Sebaik-baik manusia adalah yang paling bermanfaat bagi orang lain." <br> <span
                    class="fw-bold">-Rasulullah SAW-</span></p>
        </div>
    </section>
