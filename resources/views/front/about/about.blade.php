...
@section('content')
    ...
    <section class="hero-section2 w-100" style="background-image: url('/images/hero-bg-2.svg');">
        ...
        <div class="hero-content2 text-left px-5 ms-5">
            ...
            <p class="hero-subtitle2">Halaman About Us DonasiKita Foundation menjelaskan misi kami sebagai platform donasi
                yang aman, transparan, dan berdampak, serta memperkenalkan tim yang bekerja di baliknya.</p>
        </div>
    </section>
    <!-- End Hero Section -->
    <!-- Company Section -->
        ...
        <div class="container-fluid py-5 justify-content-center text-left bg-skyline">
            <div class="row mx-auto text-wrap" style="width:80%;">
                ...
                <div class="col-lg-6 col-12 text-dark align-items-center px-5">
                    ...
                    <p>
                        DonasiKita Foundation adalah organisasi nirlaba yang bertujuan mempermudah proses donasi bagi
                        masyarakat dengan menyediakan platform aman dan transparan. Kami mendukung berbagai kampanye
                        kemanusiaan dan sosial, membantu para donatur memberikan dampak positif bagi yang membutuhkan di
    ...
    <section id="company-leader"
        ...
        <img src="/images/about/leader.svg" class="img img-fluid leader-image rounded-3 rounded img-about" alt="">
                    ...
                    <div class="card-box swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/lestari.svg" class="img img-fluid" alt="Lestari Dewi" />
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/andi.svg" class="img img-fluid" alt="Andi Wijaya" />
                            </div>
                            <div class="content-box">
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/maya.svg" class="img img-fluid" alt="Maya Puspita" />
                            </div>
                            <div class="content-box">
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/ridwan.svg" class="img img-fluid" alt="Ridwan Santoso" />
                            </div>
                            <div class="content-box">
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/fitri.svg" class="img img-fluid" alt="Fitri Rahmawati" />
                            </div>
                            <div class="content-box">
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/dika.svg" class="img img-fluid" alt="Dika Saputra" />
                            </div>
                            <div class="content-box">
                        ...
                        <div class="swiper-slide">
                            <div class="content-img">
                                <img src="/images/about/nina.svg" class="img img-fluid" alt="Nina Amalia" />
                            </div>
                            <div class="content-box">
