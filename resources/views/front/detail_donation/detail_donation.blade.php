    ...
    <div class="card shadow rounded-4">
        <div class="container pt-5 px-lg-5 px-md-4 px-3 mt-lg-4" style="padding-left: 2.225rem !important; padding-right: 2.225rem !important;">
            ...
            <div class="py-4">
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <p class="mb-0 h3 text-secondary fw-light" style="color: #145071 !important;">Terkumpul: Rp 70.000.000</p>
                    </div>
                    <div class="col-6 text-end">
                        <p class="mb-0 h3 text-secondary " style="color: #145071 !important;"><strong>1,908</strong> Donatur</p>
                    </div>
                </div>
