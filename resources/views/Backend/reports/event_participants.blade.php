                ...
                <table id="dataTable" class="table table-bordered table-hover table-stripped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Search Nama Event" class="form-control form-control-sm">
                            </th>
                            <th></th>
                            <th></th>
                        </tr>
        ...
        $(document).ready(function() {
            ...
            $('#exportPdf').on('click', function() {
                ...
                window.location.href =
                    `participants/export/pdf??start_date=${start_date}&end_date=${end_date}`;
            });
            ...
            $('#exportExcel').on('click', function() {
                ...
                window.location.href =
                    `participants/export/csv?start_date=${start_date}&end_date=${end_date}`;
            });
        });
    </script>
@endsection
